...
nmap('<leader>tdb', function() ts.extensions.dap.list_breakpoints {} end, '[T]elescope [d]ap [b]reakpoints')
nmap('<leader>tdc', function() ts.extensions.dap.commands {} end, '[T]elescope [d]ap [c]ommands')
nmap('<leader>tdv', function() ts.extensions.dap.variables {} end, '[T]elescope [d]ap [v]ariables')
nmap('<leader>tdf', function() ts.extensions.dap.frames {} end, '[T]elescope [d]ap [f]rames')
nmap('<leader>tds', function() ts.extensions.dap.configurations {} end, '[T]elescope [d]ap [s]essions')
